 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://swpersonacbd.umsa.com/", wsdlLocation = "http://localhost:8080/SWPersonaCBD/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://swpersonacbd.umsa.com/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SWPersonaCBD/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://swpersonacbd.umsa.com/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://swpersonacbd.umsa.com/", "NewWebServicePort"), NewWebService.class, features);
    }
